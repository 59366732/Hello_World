...
namespace myFirstQsharp
{
    ...
    internal class __QsEntryPoint__ : Microsoft.Quantum.CsharpGeneration.EntryPointDriver.IEntryPoint<QVoid, QVoid>
    {
        ...
        public EntryPointInfo<QVoid, QVoid> Info => myFirstQsharp.HelloQ.Info;
        ...
        private static async System.Threading.Tasks.Task<int> Main(string[] args) => await new Microsoft.Quantum.CsharpGeneration.EntryPointDriver.Driver<myFirstQsharp.HelloQ, QVoid, QVoid>(new __QsEntryPoint__()).Run(args);
    }
}